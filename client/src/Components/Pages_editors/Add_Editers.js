  ...
  return (
    <>
      <div className="bar-add gap-4">
        <Link to="/issues/editors" className="w-auto p-2 text-center bg-gray-400 rounded text-white uppercase text-sm">
      ...
      <form className="grid grid-cols-3 gap-4 p-4 mt-14" encType="multipart/form-data">
        ...
        <div>
          ...
          <input
            ...
            className="w-full border-2 border-gray-300 p-1 focus:outline-emerald-600 rounded-lg"
          />
        </div>
      </form>
    </>
